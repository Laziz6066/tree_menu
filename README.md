...
**slug:** слизняк для предмета (поле слизняка)\
**menu:** внешний ключ к модели меню, указывающий меню, к которому принадлежит элемент (ForeignKey)\
**parent:** внешний ключ для самого себя, указывающий родительский элемент текущего элемента (ForeignKey, необязательно)\
